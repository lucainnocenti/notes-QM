...
\begin{prop}[a]
	The set of linear operators on an Euclidean space $\X$ is spanned by the set of density matrices on $\X$:
	\begin{equation}
...
\begin{question}
	Does it make sense to say that the result of measuring a state $\ket0+\ket1$ is a coherent superposition of the form $\ket{0,M_0}+\ket{1,M_1}$, with $\ket{M_i}$ ``macroscopic'' states of the measurement apparatus?
\end{question}

\begin{question}
	Why does the structure of tensor product fit so well with QM?
\end{question}
...
\subsection{Resource theory of quantum coherence}
...
\subsection{Coherence VS Multipartite entanglement~\parencite{regula2017converting,killoran2016converting}}
