...
\end{gathered}
\end{equation}
\highlight{(I don't fully understand this though: why are the $i=j$ terms excluded?)}
...
\highlight{I'm not sure about this actually; I guess we need to consider sets of $N$ samples and put the corresponding Fisher $I_N$ here?}
